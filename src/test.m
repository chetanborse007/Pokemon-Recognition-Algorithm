...
accuracy_ID = sum(ID_gt==ID) / img_num;display(accuracy_ID);
accuracy_CP = sum(CP_gt==CP) / img_num;display(accuracy_CP);
accuracy_HP = sum(HP_gt==HP) / img_num;display(accuracy_HP);
accuracy_stardust = sum(stardust_gt==stardust) / img_num;display(accuracy_stardust);